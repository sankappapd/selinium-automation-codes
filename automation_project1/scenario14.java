...
public class scenario14 {
	...
	public void dataimport() {
		...
		String path = ("C:\\Users\\SANKAPPA-PC\\eclipse-workspace\\selenium\\projectssel\\src\\test\\java\\pp\\ಕದಂಬ PSI ಮಾದರಿ ಪ್ರಶ್ನೆ ಪತ್ರಿಕೆ.pdf");
		WebElement file = driver.findElement(By.xpath("//i[@class='oxd-icon bi-upload oxd-file-input-icon']"));
		file.sendKeys(path);
